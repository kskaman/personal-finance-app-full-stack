...
import { Balance, Transaction } from "../types/models";
...
export const BalanceTransactionsDataContext =
  createContext<BalanceTransactionsDataContextProps>({
...
export const BalanceTransactionsActionContext =
  createContext<BalanceTransactionActionsContextProps>({
    addTransaction: () => {},
    setBalance: () => {},
    setTransactions: () => {},
  });
